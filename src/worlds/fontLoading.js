export default {
	stamps: [
		{
			...
			y: 526.1806151153287,
			editorWidth: 760.5389479139708,
			editorHeight: 233.81938488467136,
			iframeWidth: 200,
			iframeHeight: 200,
			isIndex: true,
			isTxtFile: false,
		...
		},
		{
			...
			x: 864.5086983685953,
			y: 1010.5636121171971,
			editorWidth: 233.49130163140467,
			editorHeight: 209.43638788280325,
			iframeWidth: 400,
			iframeHeight: 200,
			isIndex: false,
			isTxtFile: false,
		...
		},
		{
			...
			args: "",
			x: 1599.7251621650755,
			y: 1136.1987434920309,
			editorWidth: 158.27483783492426,
			editorHeight: 205.08061765657067,
			iframeWidth: 400,
			iframeHeight: 200,
			isIndex: false,
			isTxtFile: false,
		...
		},
		{
			...
			args: "",
			x: 2329.375495771216,
			y: 1154.6098186446823,
			editorWidth: 168.6245042287842,
			editorHeight: 205.39018135531774,
			iframeWidth: 400,
			iframeHeight: 200,
			isIndex: false,
			isTxtFile: false,
	...
	scale: 0.47723083868622634,
	originX: -25.914848266555055,
	originY: -24.09968727200669,
	worldKey: "starter",
	worldEdited: true,
	snapToGrid: false,
	linesOn: false,
