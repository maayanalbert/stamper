...
function jsToStamps(rawCode){
    var program = esprima.parseScript(rawCode, {range:true, comment:true, tolerant:true, loc:true})
  ...
  function fillStampArrays(body, blobStamps, fnStamps, rawCode){
    ...
    for(var i = 0; i < body.length; i++){
      ...
      if(item.type === "FunctionDeclaration"){
        ...
        lastBlobLine = addBlob(tempBlobStamps, item, rawCode, lastBlobLine, false)
      }
    }
